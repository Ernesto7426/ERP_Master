...
let ManejoResize = () => {
    ...
    if( $(window).height() >= 400 ) {
        $("#List_Archive").css("height",Height);
    }
}
// Manejamos el resize de los elementos del modulo
...
//               }
//               if ($('body').hasClass('hidden-navigation')) {CUSTOMÄ°ZABLE
